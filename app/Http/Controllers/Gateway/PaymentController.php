...
class PaymentController extends Controller
{
    ...
    public function depositInsert(Request $request, $id = 0)
    {
        ...
        $data->insured_plan_id = $insuredPlan->id ?? 0;
        ...
        if ($insuredPlan) {
            $data->success_url = route('user.payment.success', $insuredPlan->id);
        ...
        $insuredPlan->payment_status = Status::PAYMENT_PENDING;
        $insuredPlan->save();
        ...
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            if ($deposit->insuredPlan) {
                ...
                notify($user, 'PAYMENT_CONFIRM', [
                    ...
                    'trx'          => $deposit->trx,
                    'post_balance' => showAmount($user->balance),
                    'renewal_date' => $insuredPlan->renewal_date,
                ]);
            }
        }
    }
